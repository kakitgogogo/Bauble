...
void XML_SetCharacterDataHandler(XML_Parser p, XML_CharacterDataHandler handle);
...
static int lxp_parse(lua_State* L)
{
	...
	xpu = (lxp_userdata*)luaL_checktype(L, 1, "Expat");
...
{
	lxp_userdata* xpu = (lxp_userdata*)luaL_checktype(L, 1, "Expat");
