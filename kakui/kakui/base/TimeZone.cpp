...
{
public:
	File(const char* file): _fp(::fopen(file, "rb")) {}
...
TimeZone::TimeZone(const char* zonefile): _data(new TimeZone::Data)
{
...
TimeZone::TimeZone(int eastOfUtc, const char* name): _data(new TimeZone::Data)
{
