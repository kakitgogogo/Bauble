...
Date::Date(int y, int m, int d): _julianDayNumber(detail::getJulianDayNumber(y, m, d)) {}

Date::Date(const struct tm& t): _julianDayNumber(detail::getJulianDayNumber(t.tm_year+1900, t.tm_mon+1, t.tm_mday)) {}
